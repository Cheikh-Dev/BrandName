...
export default function SectionInfo() {
  return (
    <>
      <div className="flex flex-col justify-between md:flex-row items-center p-12 md:p-12 sm:p-32 bg-w">
        {/* Text Section */}
        <div className="md:w-1/2 mb-8 md:mb-0 p-10">
          ...
          <a href="#learn-more" className="flex jutify-center items-center text-btn font-bold hover:underline">
            Learn More
